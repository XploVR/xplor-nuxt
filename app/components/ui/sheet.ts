import { defineComponent, ref, computed, provide, inject, h, Teleport, watch, PropType } from 'vue'
...
export const Sheet = defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    const side = ref<Side>(props.side)

    provide(Key, { open: isOpen as any, setOpen: (v: boolean) => (isOpen.value = v), side })
